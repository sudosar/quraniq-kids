...
export const arabicLetters: ArabicLetter[] = [
  ...
  },
  {
    ...
    wordCards: [
      ...
      { word: 'بيت', transliteration: 'Bayt', meaning: 'House', emoji: '🏠', letterHighlightIndex: [0], position: 'beginning' },
      // MIDDLE/END words — used in Phase 2 (advanced)
  ...
  },
  {
    ...
    wordCards: [
      ...
      { word: 'تمر', transliteration: 'Tamr', meaning: 'Dates', emoji: '🌴', letterHighlightIndex: [0], position: 'beginning' },
  ...
  },
  {
    ...
    wordCards: [
      ...
      { word: 'ثوب', transliteration: 'Thawb', meaning: 'Garment', emoji: '👔', letterHighlightIndex: [0], position: 'beginning' },
      // MIDDLE/END words — used in Phase 2 (advanced)
  ...
  },
  {
    ...
    wordCards: [
      ...
      { word: 'حوت', transliteration: 'Hoot', meaning: 'Whale', emoji: '🐋', letterHighlightIndex: [0], position: 'beginning' },
      { word: 'حليب', transliteration: 'Haleeb', meaning: 'Milk', emoji: '🥛', letterHighlightIndex: [0], position: 'beginning' },
      // MIDDLE/END words — used in Phase 2 (advanced)
  ...
  },
  {
    ...
    wordCards: [
      ...
      { word: 'ذرة', transliteration: 'Dhura', meaning: 'Corn', emoji: '🌽', letterHighlightIndex: [0], position: 'beginning' },
      { word: 'ذهب', transliteration: 'Dhahab', meaning: 'Gold', emoji: '🥇', letterHighlightIndex: [0], position: 'beginning' },
      // MIDDLE/END words — used in Phase 2 (advanced)
  ...
  { id: 15, letter: 'ض', name: 'Dad', nameAr: 'ضاد', transliteration: 'ḍ', sound: 'd (emphatic, heavy)', group: 'tongue-tip', color: '#C0392B', wordCards: [{ word: 'ضفدع', transliteration: 'Difda', meaning: 'Frog', emoji: '🐸', letterHighlightIndex: [0], position: 'beginning' }, { word: 'ضوء', transliteration: 'Dawʾ', meaning: 'Light', emoji: '💡', letterHighlightIndex: [0], position: 'beginning' }, { word: 'ضباب', transliteration: 'Dabab', meaning: 'Fog', emoji: '🌫️', letterHighlightIndex: [0], position: 'beginning' }], quranicWords: [{ word: 'ضَلَال', surah: 'Al-Fatiha', meaning: 'Astray', letterHighlightIndex: [0] }] },
  { id: 16, letter: 'ط', name: 'Taa', nameAr: 'طاء', transliteration: 'ṭ', sound: 't (emphatic, heavy)', group: 'tongue-tip', color: '#27AE60', wordCards: [{ word: 'طائر', transliteration: 'Taair', meaning: 'Bird', emoji: '🐦', letterHighlightIndex: [0], position: 'beginning' }, { word: 'طبل', transliteration: 'Tabl', meaning: 'Drum', emoji: '🥁', letterHighlightIndex: [0], position: 'beginning' }, { word: 'طماطم', transliteration: 'Tamaatim', meaning: 'Tomato', emoji: '🍅', letterHighlightIndex: [0], position: 'beginning' }], quranicWords: [{ word: 'طَيْر', surah: 'Al-Fil', meaning: 'Birds', letterHighlightIndex: [0] }] },
  { id: 17, letter: 'ظ', name: 'Dhaa', nameAr: 'ظاء', transliteration: 'ẓ', sound: 'dh (emphatic, heavy)', group: 'tongue-tip', color: '#2980B9', wordCards: [{ word: 'ظرف', transliteration: 'Dharf', meaning: 'Envelope', emoji: '✉️', letterHighlightIndex: [0], position: 'beginning' }, { word: 'ظل', transliteration: 'Dhill', meaning: 'Shadow', emoji: '🌑', letterHighlightIndex: [0], position: 'beginning' }, { word: 'ظبي', transliteration: 'Dhaby', meaning: 'Deer', emoji: '🦌', letterHighlightIndex: [0], position: 'beginning' }], quranicWords: [{ word: 'ظُلُمَات', surah: 'Al-Baqarah', meaning: 'Darkness', letterHighlightIndex: [0] }] },
  { id: 18, letter: 'ع', name: 'Ayn', nameAr: 'عين', transliteration: 'ʿ', sound: 'deep throat sound', group: 'throat', color: '#8E44AD', wordCards: [{ word: 'عنب', transliteration: 'Inab', meaning: 'Grapes', emoji: '🍇', letterHighlightIndex: [0], position: 'beginning' }, { word: 'عصفور', transliteration: 'Usfoor', meaning: 'Sparrow', emoji: '🐦', letterHighlightIndex: [0], position: 'beginning' }, { word: 'عسل', transliteration: 'Asal', meaning: 'Honey', emoji: '🍯', letterHighlightIndex: [0], position: 'beginning' }], quranicWords: [{ word: 'عَلِيم', surah: 'Al-Baqarah', meaning: 'All-Knowing', letterHighlightIndex: [0] }] },
  ...
  { id: 20, letter: 'ف', name: 'Fa', nameAr: 'فاء', transliteration: 'f', sound: 'f (like "f" in "fish")', group: 'lips', color: '#16A085', wordCards: [{ word: 'فيل', transliteration: 'Feel', meaning: 'Elephant', emoji: '🐘', letterHighlightIndex: [0], position: 'beginning' }, { word: 'فراشة', transliteration: 'Farasha', meaning: 'Butterfly', emoji: '🦋', letterHighlightIndex: [0], position: 'beginning' }, { word: 'فراولة', transliteration: 'Farawla', meaning: 'Strawberry', emoji: '🍓', letterHighlightIndex: [0], position: 'beginning' }], quranicWords: [{ word: 'فَلَق', surah: 'Al-Falaq', meaning: 'Daybreak', letterHighlightIndex: [0] }] },
  { id: 21, letter: 'ق', name: 'Qaf', nameAr: 'قاف', transliteration: 'q', sound: 'q (deep back of throat)', group: 'back-tongue', color: '#C0392B', wordCards: [{ word: 'قطة', transliteration: 'Qitta', meaning: 'Cat', emoji: '🐱', letterHighlightIndex: [0], position: 'beginning' }, { word: 'قمر', transliteration: 'Qamar', meaning: 'Moon', emoji: '🌙', letterHighlightIndex: [0], position: 'beginning' }, { word: 'قلم', transliteration: 'Qalam', meaning: 'Pen', emoji: '✏️', letterHighlightIndex: [0], position: 'beginning' }], quranicWords: [{ word: 'قُلْ', surah: 'Al-Ikhlas', meaning: 'Say', letterHighlightIndex: [0] }] },
  { id: 22, letter: 'ك', name: 'Kaf', nameAr: 'كاف', transliteration: 'k', sound: 'k (like "k" in "kite")', group: 'back-tongue', color: '#2ECC71', wordCards: [{ word: 'كلب', transliteration: 'Kalb', meaning: 'Dog', emoji: '🐕', letterHighlightIndex: [0], position: 'beginning' }, { word: 'كتاب', transliteration: 'Kitaab', meaning: 'Book', emoji: '📖', letterHighlightIndex: [0], position: 'beginning' }, { word: 'كرة', transliteration: 'Kura', meaning: 'Ball', emoji: '⚽', letterHighlightIndex: [0], position: 'beginning' }], quranicWords: [{ word: 'كَوْثَر', surah: 'Al-Kawthar', meaning: 'Abundance', letterHighlightIndex: [0] }] },
  { id: 23, letter: 'ل', name: 'Lam', nameAr: 'لام', transliteration: 'l', sound: 'l (like "l" in "light")', group: 'tongue-tip', color: '#E74C3C', wordCards: [{ word: 'ليمون', transliteration: 'Laymoon', meaning: 'Lemon', emoji: '🍋', letterHighlightIndex: [0], position: 'beginning' }, { word: 'لعبة', transliteration: 'Luʿba', meaning: 'Toy', emoji: '🧸', letterHighlightIndex: [0], position: 'beginning' }, { word: 'لحم', transliteration: 'Lahm', meaning: 'Meat', emoji: '🥩', letterHighlightIndex: [0], position: 'beginning' }], quranicWords: [{ word: 'لَهُ', surah: 'Al-Ikhlas', meaning: 'For Him', letterHighlightIndex: [0] }] },
  { id: 24, letter: 'م', name: 'Meem', nameAr: 'ميم', transliteration: 'm', sound: 'm (like "m" in "moon")', group: 'lips', color: '#9B59B6', wordCards: [{ word: 'موز', transliteration: 'Mawz', meaning: 'Banana', emoji: '🍌', letterHighlightIndex: [0], position: 'beginning' }, { word: 'مفتاح', transliteration: 'Miftah', meaning: 'Key', emoji: '🔑', letterHighlightIndex: [0], position: 'beginning' }, { word: 'ماء', transliteration: 'Maa', meaning: 'Water', emoji: '💧', letterHighlightIndex: [0], position: 'beginning' }], quranicWords: [{ word: 'مَالِك', surah: 'Al-Fatiha', meaning: 'Master/Owner', letterHighlightIndex: [0] }] },
  { id: 25, letter: 'ن', name: 'Noon', nameAr: 'نون', transliteration: 'n', sound: 'n (like "n" in "noon")', group: 'tongue-tip', color: '#F39C12', wordCards: [{ word: 'نحلة', transliteration: 'Nahla', meaning: 'Bee', emoji: '🐝', letterHighlightIndex: [0], position: 'beginning' }, { word: 'نجمة', transliteration: 'Najma', meaning: 'Star', emoji: '⭐', letterHighlightIndex: [0], position: 'beginning' }, { word: 'نمر', transliteration: 'Namir', meaning: 'Tiger', emoji: '🐯', letterHighlightIndex: [0], position: 'beginning' }], quranicWords: [{ word: 'نَاس', surah: 'An-Nas', meaning: 'Mankind', letterHighlightIndex: [0] }] },
  { id: 26, letter: 'ه', name: 'Ha', nameAr: 'هاء', transliteration: 'h', sound: 'h (like "h" in "hat")', group: 'throat', color: '#1ABC9C', wordCards: [{ word: 'هلال', transliteration: 'Hilal', meaning: 'Crescent', emoji: '🌙', letterHighlightIndex: [0], position: 'beginning' }, { word: 'هدية', transliteration: 'Hadiyya', meaning: 'Gift', emoji: '🎁', letterHighlightIndex: [0], position: 'beginning' }, { word: 'هرة', transliteration: 'Hirra', meaning: 'Cat', emoji: '🐈', letterHighlightIndex: [0], position: 'beginning' }], quranicWords: [{ word: 'هُوَ', surah: 'Al-Ikhlas', meaning: 'He (is)', letterHighlightIndex: [0] }] },
  { id: 27, letter: 'و', name: 'Waw', nameAr: 'واو', transliteration: 'w', sound: 'w (like "w" in "water")', group: 'lips', color: '#3498DB', wordCards: [{ word: 'وردة', transliteration: 'Warda', meaning: 'Rose', emoji: '🌹', letterHighlightIndex: [0], position: 'beginning' }, { word: 'وجه', transliteration: 'Wajh', meaning: 'Face', emoji: '😊', letterHighlightIndex: [0], position: 'beginning' }, { word: 'ولد', transliteration: 'Walad', meaning: 'Boy', emoji: '👦', letterHighlightIndex: [0], position: 'beginning' }], quranicWords: [{ word: 'وَالْعَصْر', surah: 'Al-Asr', meaning: 'By time', letterHighlightIndex: [0] }] },
  { id: 28, letter: 'ي', name: 'Ya', nameAr: 'ياء', transliteration: 'y', sound: 'y (like "y" in "yes")', group: 'middle-tongue', color: '#E67E22', wordCards: [{ word: 'يد', transliteration: 'Yad', meaning: 'Hand', emoji: '✋', letterHighlightIndex: [0], position: 'beginning' }, { word: 'يمامة', transliteration: 'Yamama', meaning: 'Dove', emoji: '🕊️', letterHighlightIndex: [0], position: 'beginning' }, { word: 'يقطين', transliteration: 'Yaqteen', meaning: 'Pumpkin', emoji: '🎃', letterHighlightIndex: [0], position: 'beginning' }], quranicWords: [{ word: 'يَوْم', surah: 'Al-Fatiha', meaning: 'Day', letterHighlightIndex: [0] }] },
];
